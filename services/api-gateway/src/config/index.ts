...
export const config:Config = {
    ...
    AUTH_JWT_SECRET:process.env.AUTH_JWT_SECRET || "randomSecretKeyItIsHerefellaswotuCooking",
    GATEWAY_JWT_SECRET:process.env.GATEWAY_JWT_SECRET || "thisIsRandomgatewaySecret",
